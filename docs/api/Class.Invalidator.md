...
[xdash API Reference](/xdash/api/index.md) / Invalidator
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](/xdash/api/Class.Invalidator.md#defaultmaxlisteners).
